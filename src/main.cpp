...
void loop()
{
  ...
  Serial.print(" | gX = "); Serial.print(gyrX);
  Serial.print(" | gY = "); Serial.print(gyrY);
  Serial.print(" | gZ = "); Serial.print(gyrZ);
  ...
  Serial.print(" | T = ");  Serial.print((int16_t)temperature); Serial.print("°C");
